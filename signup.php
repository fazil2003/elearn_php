...
<center>
		...
		<br>
		<!--<h2>Realname <input type="text" name="fullname" placeholder="Full name..."  ></h2>-->
		...
		<center>Have an account?<br><a href='signup.php' style='color:white;'><b>Log in</a><br><br><br>
		<div class='footer'>&copy RithuEd . </div>
...
if($row>0){
	...
	mysqli_query($db,"INSERT INTO email_verification(email,username,password,otp,date) VALUES ('$email','$username','$password','$randomstring','$date')");
	?>
...
$mail->Username = "your_mail_id@gmail.com"; // Your Gmail address.
$mail->Password = "your_password"; // Your Gmail login password or App Specific Password.

/*
 * Message Configuration
 */

$mail->setFrom('your_mail_id@gmail.com', 'RithuEd'); // Set the sender of the message.
$mail->addAddress($email , $username); // Set the recipient of the message.
$mail->Subject = 'This is your OTP(One Time Password) for RithuEd.'; // The subject of the message.
...
if ($mail->send()) {
	...
	mail($email,'This is your OTP(One Time Password) for RithuEd.',$otp);
